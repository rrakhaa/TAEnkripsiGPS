...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('driver.update', ['id' => $data->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                  <!-- left column -->
                      ...
                      <form>
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="alamat" class="form-control" id="alamat" value="{{ $data->alamat }}" placeholder="Masukkan Alamat">
                            @error('alamat')
                            <small>{{ $message }}</small>
                            @enderror
                          </div>
                          <div class="form-group">
                            ...
                            <input type="text" name="notelp" class="form-control" id="notelp" value="{{ $data->notelp }}" placeholder="Masukkan No Telp">
                            @error('notelp')
                            <small>{{ $message }}</small>
                            @enderror
                        </div>
